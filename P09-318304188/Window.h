...
public:
	...
	//devuelven los valores de rotación sobre los ejes X, Y y Z:
	...
	//devuelven el estado de los interruptores booleanos que controlan distintos aspectos de la interacción:
