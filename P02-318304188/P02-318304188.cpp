...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//siempre se recomienda establecer el valor de z en negativo para asegurarnos de que el objeto se dibujará dentro del monitor
		...
		//angulo += 0.01; //Cambiar velocidad de rotación
		//Inicializar matriz de dimensión 4x4 que servirá como matriz de modelo para almacenar las transformaciones geométricas
		model = glm::mat4(1.0);
