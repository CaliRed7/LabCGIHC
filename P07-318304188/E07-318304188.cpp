...
int main()
{
	...
	mainLight = DirectionalLight(1.0f, 1.0f, 1.0f,
		0.15f, 0.15f,//intensidad ambiental - qué tan fuerte va a irradiar la luz el sol // el primero para la intensidad //el segundo para que abarque +/- distancia o rango de iluminación
		0.0f, -1.0f, 0.0f);//si cambiamos este valor, se verá cómo la luz blanca está apuntando a cierta parte del coche, en este caso apunta a -1 en z y por ello se ilumina el lateral izq del coche
							//para el ejercicio está en -1 en 'y' para que le iluminación sea general/paralela al plano
	...
	*/
	...
	//=========================================================================
	//faro
	spotLights[1] = SpotLight(0.0f, 0.0f, 1.0f,// Color de la luz (azul)
		5.0f, 5.0f, //intensidad ambiental e intensidad difusa
		0.0f, 0.0f, 0.0f, //posición del haz
		-1.0f, 0.0f, 0.0f, //dirección del haz (los valores son 0 o 1) -> en este caso es -1 en x para que ilumine en dirección frontal del coche como si fuera faro
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Auto_M.RenderModel();
		spotLights[1].SetPos(glm::vec3(-6.0 + mainWindow.getmuevex(), 1.0f, -3.25f));
		...
		*/
		...
		//Para el ejercicio dejo el agave para que se note que la luz ilumina enfrente
