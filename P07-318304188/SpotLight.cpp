...
SpotLight::SpotLight() : PointLight()//si no se declara una ???? entonces se usa lo siguiente
{
...
{
	direction = glm::normalize(glm::vec3(xDir, yDir, zDir));//si se declara el vector ?? se normaliza y se modifican los vlaores en tiempo de posición:
