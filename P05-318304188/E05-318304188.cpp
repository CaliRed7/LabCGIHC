...
int main()
{
	...
	Goddard_Pata1 = Model();
	Goddard_Pata1.LoadModel("Models/pata1.obj");
	Goddard_Pata2 = Model();
	Goddard_Pata2.LoadModel("Models/pata2.obj");
	Goddard_Pata3 = Model();
	Goddard_Pata3.LoadModel("Models/pata3.obj");
	Goddard_Pata4 = Model();
	Goddard_Pata4.LoadModel("Models/pata4.obj");
...
//	-	//Goddard Cabeza
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.85f, 3.2f, 0.5f));
...
//	-	//Goddard Mandíbula
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.75f, 3.25f, 0.5f));
...
//	-	//pata delantera derecha -> pata2
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.3f, 2.2f, 1.2f));
...
//	-	// pata delantera izquierda -> pata1
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.3f, 2.125f, -0.05f));
...
//	-	//pata trasera derecha -> pata4
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.25f, 1.475f, 1.2f));
...
//	-	//pata trasera izquierda -> pata3
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.25f, 1.485f, -0.05f));
